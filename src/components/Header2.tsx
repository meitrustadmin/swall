    ...
    <header className="">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl justify-between p-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a key={item.name} href={item.href} className="text-normal leading-6 font-normal text-violet-900">
              {item.name}
            </a>
          ))}
        </div>
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg: bg-purple-600">
